...
payroll.title(" Rohan's Payroll Management Systems")
...
lblTitle = Label(Tops, font=('arial', 50, 'bold'), text=" Rohan Payroll Management Systems", fg="Steel blue", bd=10, anchor="w")
...
lblStudenLoan = Label(InsideLFR, font=('arial', 12, 'bold'), text="StudentLoan", fg="Steel blue", bd=10, anchor="w")
...
lblNIPavment = Label(InsideLFR, font=('arial', 12, 'bold'), text="NI Payment", fg="Steel blue", bd=10, anchor="w")
...
lblDeducations = Label(InsideLFR, font=('comic sans', 12, 'bold'), text="Deducations", fg="Steel blue", bd=10, anchor="w")
